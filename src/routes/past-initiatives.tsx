...
export const Route = createFileRoute("/past-initiatives")({
  head: () => ({
    meta: [
      { title: "Past Initiatives — GWY Conference & more" },
      {
        name: "description",
        content:
          "A look back at GWYCONF'26, GWY Pre-Conf and the moments that turned strangers into community.",
      },
      { property: "og:title", content: "Past Initiatives — DoraDAO" },
      {
